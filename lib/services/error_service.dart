...
class ErrorService {
  ...
  static AppError createDatabaseError(String operation, dynamic error,
  ...
  static AppError createDataError(String operation,
  ...
  static AppError createNetworkError(String operation, dynamic error,
      [StackTrace? stackTrace]) {
  ...
  static AppError createFileSystemError(String operation, dynamic error,
      [StackTrace? stackTrace]) {
